...
** Schedule proposals
When a titular opens his schedule, he has the option to reschedule one
...
titular can not make any final changes to a schedule. He can however
propose his changes to one or more program manager.
