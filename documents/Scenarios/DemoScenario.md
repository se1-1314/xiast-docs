...
Ik heb net vernomen dat de vakgroepraad heeft beslist om het **vak 'Software Engineering' niet meer te geve**n in de bachelor CW. Via de program-edit functionaliteit kan dit vak verwijderd worden door de juiste cursuscode op te zoeken en deze via de **add/deletknop** onderaan in te geven. Een klik op delete verwijderd de cursus uit het programma. Het aanmaken en/of verwijderen van een cursus verloopt op dezelfde manier. <br/> 
